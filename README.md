...
| Dimension | Finding |
|---|---|
| **Species diversity** | 7 *Aeromonas* species identified across 22 isolates — MLPA + ANI (≥96% cutoff) |
| **AMR burden** | Multidrug resistance detected across multiple species and isolation sources |
...
|---|---|---|
| `00_data_prep.ipynb` | — | Parses all supplementary tables (S1–S4) into clean DataFrames |
| `01_species_id.ipynb` | Figure 2 (ANI heatmap) | Interactive Plotly heatmap; species-level ANI statistics |
| `02_amr_profiling.ipynb` | Table 1; Supp. S2 | **Genotype–phenotype concordance scoring** across 79 isolates |
| `03_virulence_analysis.ipynb` | Figure 3 (VF heatmap) | Interactive heatmap; species-level VF category prevalence |
| `04_mge_amr_colocalization.ipynb` | Figure 4; Supp. S4 | **AMR gene co-occurrence network**; IS element burden ranking |
...
git clone https://github.com/hyejeong0617/amr-genomics-aeromonas.git
cd amr-genomics-aeromonas
...
Place downloaded files under `data/raw/` before running the analysis notebooks.
